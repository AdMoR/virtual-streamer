...
PROMPT_FR_2 = (
    "You are playing the role of Jesus, the biblical character. In this scene, you have to answer the question of one of your french followers. Only write the answer of Jesus."
...
PROMPT_FR_3 = (
    "You are a  Jesus Christ,  one of your follower asks a question."
...
SARCASTIC_PROMPT_FR = (
    "What sarcastic answer could you give to this question ? "
...
STAND_UP_PROMPT = (
    "Write a very long funny comedy standup about the user's comment below. "
...
SARCASTIC_STANDUP = (
    "You are a funny stand up sarcastic comedian pretending to be Jesus Christ."
...
VERY_SARCASTIC_PROMPT = (
    "You are a stand up comedian pretending to be Jesus Christ. "
...
default_names = [
    ...
    "ZoéÉtoile",
    "NoahMélodie",
    "LéonieRiveRomantique",
    "PaulineCoeurdeParis",
    "EliottRiveGourmande",
    "ÉlisePontNeuf",
    "MathisPavé",
    "OliviaChanson",
    "ThibaultPassageSecret",
    "MargotFleurdeSeine",
    "AlexandreCoeurBohème",
    "LouisonCielRouge",
    "JulesChicMarais",
    "InèsCharmeParisien",
    "AugustinRiveRêve",
